...
export const PUBLIC_URL = (process.env.PUBLIC_URL || `http://localhost:${PORT}`)
    .replace(/\/$/, "");
export const BSKY_SERVICE_URL = process.env.BSKY_SERVICE_URL ||
    "https://bsky.social";
export const PLC_DIRECTORY_URL = process.env.PLC_DIRECTORY_URL ||
    "https://plc.directory";
export const SECRET_KEY = process.env.SECRET_KEY ||
    "dev-secret-key-change-this-in-prod";
