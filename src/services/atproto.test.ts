...
describe("AtProtoService", () => {
    ...
    describe("getFollowers", () => {
        it("should fetch all followers by following cursors", async () => {
            ...
            expect(mockAgent.getFollowers).toHaveBeenCalledTimes(2);
            // Verify first call
            expect(mockAgent.getFollowers).toHaveBeenNthCalledWith(1, {
                actor: "test.bsky.social",
                cursor: undefined,
                limit: 100,
            });
            // Verify second call
            expect(mockAgent.getFollowers).toHaveBeenNthCalledWith(2, {
                actor: "test.bsky.social",
                cursor: "cursor-1",
                limit: 100,
            });
