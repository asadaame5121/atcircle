            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div class="form-control">
                        <label class="label" for="w-theme"><span class="label-text font-bold">${t("widget_builder.field_theme")}</span></label>
                    ...
                    <div class="form-control">
                        <label class="label" for="w-layout"><span class="label-text font-bold">${t("widget_builder.field_layout")}</span></label>
                ...
                <div class="flex flex-col gap-4 mb-8 text-sm">
                    <div class="form-control">
                        <label class="label" for="w-banner-url"><span class="label-text font-bold">${t("widget_builder.field_banner_url")}</span></label>
                    ...
                    <div class="flex items-center gap-4">
                        <img id="banner-preview-img" src="${bannerUrl}" alt="Banner preview" class="w-24 h-24 object-contain bg-base-300 rounded overflow-hidden ${bannerUrl ? "" : "hidden"}" />
                        <div class="flex-1">
                            <input type="file" id="banner-upload" class="file-input file-input-bordered w-full" accept="image/*" aria-label="${t("widget_builder.banner_upload_desc")}" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div class="form-control">
                        <label class="label" for="w-label-title"><span class="label-text font-bold">${t("widget_builder.label_title")}</span></label>
                        <input type="text" id="w-label-title" class="input input-bordered w-full" value="${ringTitle}" oninput="updatePreview()" />
                    </div>
                    <div class="form-control">
                        <label class="label" for="w-label-random"><span class="label-text font-bold">${t("widget_builder.label_random")}</span></label>
                        <input type="text" id="w-label-random" class="input input-bordered w-full" value="Random" oninput="updatePreview()" />
                    </div>
                    <div class="form-control">
                        <label class="label" for="w-label-list"><span class="label-text font-bold">${t("widget_builder.label_list")}</span></label>
                        <input type="text" id="w-label-list" class="input input-bordered w-full" value="List" oninput="updatePreview()" />
                    </div>
                    <div class="form-control">
                        <label class="label" for="w-css"><span class="label-text font-bold">${t("widget_builder.label_css")}</span></label>
                    ...
                    <div class="form-control">
                        <label class="label" for="w-list-url"><span class="label-text font-bold">${t("widget_builder.field_list_url")}</span></label>
